...
namespace TestAlttrashCSharp.tests
{
    public class AdAppLovin
    {
        ...
        public void RV()
        {
            ...
            for (int i = 1; i < 12; i++)
            {
                for (int j = 1; j < 6; j++)
                {
                    ...
                    if (title != null && title.Equals("applovin", StringComparison.InvariantCultureIgnoreCase))
                    {
                        itemAd.Click();
                        isFound = true;
                        break;
            ...
            Assert.NotNull(ad);
            Assert.AreEqual(ad.ad_source, "applovin");
        ...
        public void FS()
        {
            ...
            var ad = SetupUtils.ReturnAdPlatformObject(list);
            Assert.NotNull(ad);
            Assert.AreEqual(ad.ad_source.ToLower(), "applovin");
            Assert.True(ad.value < 1);
        }
