    ...
    public class AdUnityads
    {
        ...
        public void RV()
        {
            ...
            for (int i = 1; i < 12; i++)
            {
                for (int j = 1; j < 6; j++)
                {
                    ...
                    if (title != null && title.Equals("unityads", StringComparison.InvariantCultureIgnoreCase))
                    {
                        itemAd.Click();
                        isFound = true;
                        break;
            ...
            Assert.NotNull(ad);
            Assert.AreEqual(ad.ad_source, "unityads");
      ...
      /*  [Test]
        public void BN()
        {
            ...
            var ad = SetupUtils.ReturnAdPlatformObject(list);
            Assert.NotNull(ad);
            Assert.AreEqual(ad.ad_source, "unity ads");
            Assert.True(ad.value < 1);
        }*/
